...
public final class DeleteAccDialogBinding implements ViewBinding {
  @NonNull
  ...
  private DeleteAccDialogBinding(@NonNull RelativeLayout rootView, @NonNull TextView desTxt,
      @NonNull RelativeLayout noBtn, @NonNull TextView noText, @NonNull TextView tText,
      @NonNull CardView updateCardview, @NonNull RelativeLayout withSkipBtnLayout,
      @NonNull RelativeLayout yesBtn, @NonNull TextView yesText) {
  ...
  @NonNull
  public static DeleteAccDialogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DeleteAccDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.delete_acc_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DeleteAccDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DeleteAccDialogBinding((RelativeLayout) rootView, desTxt, noBtn, noText, tText,
          updateCardview, withSkipBtnLayout, yesBtn, yesText);
    }
