...
public final class ActivityDetailBinding implements ViewBinding {
  ...
  private ActivityDetailBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backBtn,
      @NonNull ChipGroup chipGroup, @NonNull LinearLayout copyTxt, @NonNull TextView createMatch,
      @NonNull LinearLayout favIcon, @NonNull ImageView favImg, @NonNull TextView feedbackBtn,
      @NonNull TextView firstInter, @NonNull LinearLayout parentLayout,
      @NonNull TextView presonsName, @NonNull Button regenerateBtn, @NonNull CardView tCardView,
      @NonNull TextView thomasJPeCopy, @NonNull Toolbar toolbar) {
  ...
  public static ActivityDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailBinding((ConstraintLayout) rootView, backBtn, chipGroup, copyTxt,
          createMatch, favIcon, favImg, feedbackBtn, firstInter, parentLayout, presonsName,
