...
public final class ActivityPersonInterestBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityPersonInterestBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityPersonInterestBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPersonInterestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_person_interest, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPersonInterestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPersonInterestBinding((ConstraintLayout) rootView, backBtn, chipGroup,
