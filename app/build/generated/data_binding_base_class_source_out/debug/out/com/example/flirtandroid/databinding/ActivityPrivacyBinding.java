...
public final class ActivityPrivacyBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout chgPwBtn;

  @NonNull
  public final Toolbar toolbar;

  private ActivityPrivacyBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView backBtn,
      @NonNull LinearLayout chgPwBtn, @NonNull Toolbar toolbar) {
    this.rootView = rootView;
    this.backBtn = backBtn;
    this.chgPwBtn = chgPwBtn;
  ...
  public static ActivityPrivacyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.chg_pw_btn;
      LinearLayout chgPwBtn = ViewBindings.findChildViewById(rootView, id);
      if (chgPwBtn == null) {
        break missingId;
      }
      ...
      return new ActivityPrivacyBinding((ConstraintLayout) rootView, backBtn, chgPwBtn, toolbar);
    }
