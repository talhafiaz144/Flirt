...
public final class LogoutDialog2Binding implements ViewBinding {
  @NonNull
  ...
  private LogoutDialog2Binding(@NonNull RelativeLayout rootView, @NonNull TextView desTxt,
  ...
  @NonNull
  public static LogoutDialog2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LogoutDialog2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.logout_dialog2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LogoutDialog2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LogoutDialog2Binding((RelativeLayout) rootView, desTxt, noBtn, noText, tText,
