...
public class ApiErrorSnackBar {
    public static void showSnackbar(Activity activity, String message) {
        ...
        View customSnackbarView = activity.getLayoutInflater().inflate(R.layout.api_snackbar_layout, null);
        ImageView iconImageView = customSnackbarView.findViewById(R.id.snackbar_icon2);
        TextView textView = customSnackbarView.findViewById(R.id.snackbar_text2);
        ImageView dismissImageView = customSnackbarView.findViewById(R.id.snackbar_dismiss2);
